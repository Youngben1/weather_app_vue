<template>
	<header class="sticky top-0 text-weather-primary shadow-lg">
		<nav
			class="container flex flex-col items-center gap-4 text-white py-6 sm:flex-row"
		>
			<RouterLink :to="{ name: 'home' }">
				<div class="flex items-center gap-3">
					<i class="fa-solid fa-sun text-2xl"></i>
					<p class="text-2xl">The International Weather</p>
				</div>
			</RouterLink>
		...
		<BaseModal :modalActive="modalActive" @click="toggleModal">
